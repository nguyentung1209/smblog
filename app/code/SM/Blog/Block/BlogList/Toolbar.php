 ...
 */
namespace SM\Blog\Block\BlogList;

use Magento\Catalog\Helper\Product\ProductList;
use SM\Blog\Model\Blog\BlogList\Toolbar as ToolbarModel;
...
class Toolbar extends \Magento\Framework\View\Element\Template
{
     ...
     * @var string
     */
    protected $_template = 'Magento_Catalog::product/list/toolbarTop.phtml';
    ...
    {
        return count($this->getBlogCollection());
    }
...
//    }
    ...
    public function getWidgetOptionsJson(array $customOptions = [])
    {
        ...
        $options = [
            ...
            'blog' => $this->toolbarMemorizer->isMemorizingAllowed() ? true : false
        ];
        $options = array_replace_recursive($options, $customOptions);
        return json_encode(['blogListToolbarForm' => $options]);
    }
