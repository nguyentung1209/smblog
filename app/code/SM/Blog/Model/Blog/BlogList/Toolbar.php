 ...
 */
namespace SM\Blog\Model\Blog\BlogList;
...
class Toolbar
{
     ...
     */
    const ORDER_PARAM_NAME = 'blog_list_order';

    /**
     * Sort direction cookie name
     */
    const DIRECTION_PARAM_NAME = 'blog_list_dir';

    /**
     * Sort mode cookie name
     */
    const MODE_PARAM_NAME = 'blog_list_mode';

    /**
     * Products per page limit order cookie name
     */
    const LIMIT_PARAM_NAME = 'blog_list_limit';
